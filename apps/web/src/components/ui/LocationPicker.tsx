...
export default function LocationPicker({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white dark:bg-gray-900 rounded-lg w-full max-w-2xl flex flex-col shadow-xl overflow-hidden h-[90vh] max-h-[600px]">
        {/* Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-150">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white/90 flex items-center gap-2">
            <MapPin className="h-5 w-5 text-primary-600 dark:text-brand-400" />
        ...
        {/* Search Input */}
        <form onSubmit={handleSearch} className="p-4 border-b border-gray-100 dark:border-gray-800 flex gap-2">
        ...
        {/* Map Area */}
        <div className="flex-1 bg-gray-50 dark:bg-white/[0.04] relative">
          <div ref={mapRef} className="w-full h-full" style={{ minHeight: '300px' }} />
        </div>

        {/* Selected Address Display & Confirmation */}
        <div className="p-6 border-t border-gray-150 bg-gray-50 dark:bg-white/[0.04]">
          <div className="mb-4">
