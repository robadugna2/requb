  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        secondary:
          "border-transparent bg-gray-100 dark:bg-white/[0.08] text-gray-900 dark:text-white/90 hover:bg-gray-200 dark:hover:bg-white/[0.12]",
        destructive:
          "border-transparent bg-red-600 text-white shadow hover:bg-red-700",
        outline: "text-gray-900 dark:text-white/90",
      },
    },
    defaultVariants: {
      variant: "default",
