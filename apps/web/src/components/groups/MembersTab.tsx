    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Members & Shares</h3>
        ...
        {sharesLoading ? (
          <div className="flex items-center justify-center py-16">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-sm text-gray-500">Loading member roster…</p>
            </div>
          </div>
                    ...
                    <td className="table-cell">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-gray-500">{row.member.phone}</p>
                        </div>
                        {row.mergedGroupName && (
                          <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] bg-violet-50 text-violet-600 font-medium" title={`Merged: ${row.mergedGroupName}`}>
                            {row.mergedGroupName}
                          </span>
                        )}
                      </div>
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Merged Member Groups (ድርሻ ማጣመር)</h3>
            <p className="text-sm text-gray-500">Combine multiple members into a single share slot</p>
          </div>
          {canManage && (
        ...
        {mergedGroups.length > 0 ? (
              ...
              <div key={mg.id} className={`border rounded-xl p-4 transition-all ${mg.status === 'DISSOLVED' ? 'bg-gray-50 border-gray-200 opacity-60' : 'bg-white border-gray-200 hover:border-indigo-200 hover:shadow-sm'}`}>
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">{mg.slots.length} members · {mg.totalShares} shares</p>
                    </div>
                  </div>
                  {mg.status === 'ACTIVE' && (
                ...
                {depositHistory[mg.id] && (
                  <div className="mt-3 border-t border-gray-100 pt-3">
                    <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Deposit History</p>
          ...
          <div className="text-center py-12">
            <Users className="h-10 w-10 text-gray-300 mx-auto mb-3" />
            <p className="text-gray-500 text-sm">No merged groups yet.</p>
            <p className="text-xs text-gray-400 mt-1">Merge 2–4 members into one shared slot if they contribute together.</p>
          </div>
        )}
      </div>
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h3 className="text-lg font-semibold text-gray-900">Admin Fee Waivers</h3>
            <p className="text-sm text-gray-500">Members temporarily excused from the admin fee</p>
          </div>
        </div>
        ...
        {feeWaivers.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-sm">No fee waivers granted.</p>
          </div>
        )}
      </div>
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Shares count</label>
      ...
      >
        <form onSubmit={handleGrantWaiver} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Duration (cycles)</label>
            <input
              type="number"
      ...
      >
        <form onSubmit={handleCreateMergedGroup} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Members (2–4)</label>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Total Shares</label>
            <input
              type="number"
                  ...
                  <div>
                    ...
                    <ul className="divide-y divide-gray-50">
                      {suggestedFromOtherGroups.map((member) => (
                        <li key={member.id} className="flex items-center justify-between px-4 py-3 hover:bg-gray-50 transition-colors">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              ...
                              <div className="flex flex-wrap items-center gap-1 mt-1">
                                {member.groups.map((g, idx) => (
                                  <span key={idx} className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] bg-blue-50 text-blue-600 font-medium">
                                    {g}
                                  </span>
                                ))}
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="min-w-0">
                              ...
                              <div className="flex flex-wrap items-center gap-1 mt-1">
                                ...
                                <span className="text-[10px] text-gray-400 italic">No group yet</span>
                              </div>
                            </div>
                          </div>
                          <Button
            ...
            {showCreateForm && (
              <form onSubmit={handleCreateAndAdd} className="p-4 space-y-4 border-t border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Government ID</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-xs font-medium text-gray-700 mb-1">Telegram ID</label>
                    <input
                      type="text"
